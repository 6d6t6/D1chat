...
function renderHTML() {
  return `
    ...
    <head>
      ...
      <style>
        body { font-family: monospace; color: #fff; background: #080808; padding: 20px; }
        #messages { border: 1px solid #323232; padding: 10px; height: 300px; overflow-y: scroll; margin-bottom: 10px; }
        #form { display: flex; }
        #form input[type="text"] { flex: 1; padding: 10px; margin-right: 10px; font-family: monospace; color: #fff; background: #161616; border: none; }
        #form button { padding: 10px; font-family: monospace; color: #000; background: dodgerblue; border: none; }
        ...
        #usernameModalContent { background: #161616; padding: 8px; border-radius: 8px; text-align: center; }
        #usernameModal input[type="text"] { padding: 0 16px; margin-bottom: 0; width: auto; height: 32px; font-family: monospace; color: #fff; background: #202020; border: none; border-radius: 4px; }
        button#joinChatButton { height: 32px; border: none; border-radius: 4px; font-family: monospace; color: #000; background: dodgerblue; padding: 0 16px; text-transform: uppercase; }
      </style>
    </head>
    <body>
