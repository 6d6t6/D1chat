...
function renderHTML() {
  return `
    ...
    <head>
      ...
      <style>
        body { font-family: monospace; color: #fff; background: #080808; padding: 0; margin: 0; }
        #messages { border: none; border-radius: 8px; background: #161616; padding: 0; height: calc(100vh - 72px); overflow-y: scroll; margin: 8px; }
        ...
        #form input[type="text"] { flex: 1; padding: 0 16px; height: 48px; font-family: monospace; font-size: 16px; color: #fff; background: #161616; border: none; border-radius: 8px; line-height: 1; margin: 8px 0 8px 8px; }
        #form button { padding: 0 16px; font-family: monospace; font-size: 16px; line-height: 1; color: #000; background: #ec8dd2; border: none; border-radius: 8px; margin: 8px; }
        ...
        #usernameModalContent { background: #161616; border-radius: 8px; text-align: center; max-width: 318px !important; padding: 24px 0; border: 1px solid #202020; }
        #usernameModalContent h2 { margin: 0; padding: 8px 16px; }
        #usernameModalContent p { padding: 8px 16px; margin: 0; }
        #usernameModalContent blockquote { margin: 0; padding: 8px 16px; }
        #usernameModal input[type="text"] { padding: 0 16px; width: auto; height: 48px; font-family: monospace; color: #fff; background: #202020; border: none; border-radius: 8px; }
        button#joinChatButton { height: 48px; border: none; border-radius: 8px; font-family: monospace; color: #000; background: #ec8dd2; padding: 0 16px; text-transform: uppercase; }
        /* SCROLLBAR */
    ...
    <body>
      ...
      <div id="usernameModal">
        <div id="usernameModalContent">
          <h2>Welcome</h2>
          <p>You are about to join a chat room that is currently unmoderated. There is also currently no authentication, meaning (while we DO NOT encourage anyone to do this) anyone could pretend to be anyone.</p>
